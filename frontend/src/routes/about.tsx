...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [{ title: "Factorio Builds | About" }] }),
  component: AboutPage,
})
    ...
    <LayoutDefault title="About">
      <Container direction="column" size="small">
        ...
        <p>
          ...
          blueprints, with strong values in user experience to make it the
          least painful experience to search/filter, and create builds.
        </p>

        <h2>How to help</h2>
        <p>
          If you are a developer and wish to help, the project is{" "}
          <Link href={GH_REPO}>open source on GitHub</Link>. Otherwise, any
          idea, feedback and suggestion is welcome, either on our{" "}
        ...
        <h2>What&apos;s next?</h2>
        <p>
          We have our <Link href={GH_SHORT_ROADMAP}>short-term roadmap</Link>{" "}
          and <Link href={GH_LONG_ROADMAP}>long-term roadmap</Link> available.
        </p>

        <h2>Who</h2>
        <p>
          This project is currently maintained majorly by two developers,{" "}
          <Link href="https://github.com/veksen">@veksen</Link>, who handles
          the React front-end, and{" "}
          <Link href="https://github.com/dstockhammer">@dstockhammer</Link>,
          who handles the .NET core back-end, and the infrastucture. Special
          shoutout to{" "}
          <Link href="https://github.com/kenperkins">@kenperkins</Link> for
          his early contribution.
        </p>
      </Container>
    </LayoutDefault>
  )
