...
-   A [**dockerised**](fbsr) build of [Factorio-FBSR](https://github.com/demodude4u/Factorio-FBSR) (upstream master) that exposes its built-in HTTP Web API to render blueprint images
