...
namespace FactorioTech.Web.Core
{
    ...
    public record Entity
    {
        ...
        /// </summary>
        public IEnumerable<KeyValuePair<string, uint>> Items { get; init; } = Enumerable.Empty<KeyValuePair<string, uint>>();
        ...
        /// </summary>
        public IEnumerable<LogisticFilter> RequestFilters { get; init; } = Enumerable.Empty<LogisticFilter>();
