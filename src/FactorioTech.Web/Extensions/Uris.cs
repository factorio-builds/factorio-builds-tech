...
namespace FactorioTech.Web.Extensions
{
    ...
    {
        public static string BlueprintRaw(this IUrlHelper urlHelper, string owner, string slug, Hash? hash) =>
            hash.HasValue
        ...
        public static string BlueprintEditor(this IUrlHelper urlHelper, string owner, string slug, Hash hash) =>
            urlHelper.ActionLink(nameof(RawController.GetVersion), "Raw", new { owner, slug, hash })
