...
export class initial1604349269580 implements MigrationInterface {
  name = "initial1604349269580"
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Build" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "blueprint" text NOT NULL, "description" text NOT NULL, "json" jsonb NOT NULL, "metadata" jsonb NOT NULL, "image" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" uuid, CONSTRAINT "PK_b24a0bfb6f30bdb48168a24a427" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
